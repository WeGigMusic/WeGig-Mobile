       ...
       >
         <View style={styles.heroCard}>
           <View style={styles.heroIcon}>
             <Ionicons name="create-outline" size={18} color={Colours.text.primary} />
           </View>
           <View style={{ flex: 1 }}>
         ...
         <View style={[styles.card, { gap: 12 }]}>
           <Text style={styles.bigSectionTitle}>Gig details</Text>
           ...
           {mbError ? (
             <Text style={styles.errorText}>{mbError}</Text>
           ) : null}
               ...
               {mbResults.map((a, index) => {
                 ...
                 return (
                   <Pressable
                     ...
                     style={({ pressed }) => [
                       styles.suggestRow,
                       index === mbResults.length - 1 ? styles.suggestRowLast : null,
           ...
           {artistMbid ? (
             <Text style={styles.successText}>Matched artist ✓</Text>
           ) : null}
             ...
             <View style={styles.suggestCard}>
               {venueResults.map((place, index) => (
                 <Pressable
                   ...
                   style={({ pressed }) => [
                     styles.suggestRow,
                     index === venueResults.length - 1 ? styles.suggestRowLast : null,
                     pressed ? { opacity: 0.9 } : null,
                   ]}
                 >
                   <View style={{ flex: 1 }}>
                 ...
                 <View style={styles.highlightLeft}>
                   ...
                   >
                     <Ionicons
                       ...
                       size={16}
                       color={addToCalendar ? Colours.brand.primary : Colours.text.muted}
                     />
                   </View>
           ...
           <View style={styles.setlistCard}>
             <View style={styles.setlistHeaderRow}>
               ...
               <Pressable
                 ...
                 style={({ pressed }) => [
                   ...
                   setlistLoading || !canLookupSetlist
                     ? { opacity: 0.5 }
                     : null,
                 ]}
               >
             ...
             {setlistLoading ? (
               ...
               <Text style={styles.errorText}>{setlistError}</Text>
           ...
           >
             <Ionicons name="trash-outline" size={16} color={Colours.text.danger} />
             <Text style={styles.deleteButtonText}>
               {loading ? "Working…" : "Delete gig"}
             </Text>
           </Pressable>
